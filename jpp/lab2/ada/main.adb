...
procedure Main is
  package Mod_Int_IO is new Ada.Text_IO.Modular_IO (Mod_Int); use Mod_Int_IO;
...
begin
  ...
  Put_Line ("GCD: " & Integer'Image (Gcd_Result)
            & " Extended Euclidean: (" & Integer'Image (Extended_Euclidean_R.First_Number)
            & ", " & Integer'Image (Extended_Euclidean_R.Second_Number)
            & ") Factorial: " & Mod_Int'Image (Fact));
end Main;
